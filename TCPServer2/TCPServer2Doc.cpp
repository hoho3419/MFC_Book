...
void CTCPServer2Doc::PrintMessage(LPCTSTR message)
{
	...
	CTCPServer2View* pView = (CTCPServer2View*)pMainWnd->GetActiveView(); // 뷰 객체 주소 알아냄
	pView->AddMessage(message); // 메세지 함수 호출
}


void CTCPServer2Doc::ProcessAeccpt(int nErrorCode)
{
	// TODO: 여기에 구현 코드 추가.
	CString PeerAddr;
	UINT PeerPort;
