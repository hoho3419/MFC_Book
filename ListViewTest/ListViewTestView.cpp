...
BEGIN_MESSAGE_MAP(CListViewTestView, CListView)
	...
	ON_COMMAND(ID_FILE_PRINT_PREVIEW, &CListViewTestView::OnFilePrintPreview)
	ON_WM_CONTEXTMENU()
	ON_WM_RBUTTONUP()
...
void CListViewTestView::OnFilePrintPreview()
{
#ifndef SHARED_HANDLERS
...
void CListViewTestView::OnRButtonUp(UINT /* nFlags */, CPoint point)
{
	ClientToScreen(&point);
	OnContextMenu(this, point);
}

void CListViewTestView::OnContextMenu(CWnd* /* pWnd */, CPoint point)
{
#ifndef SHARED_HANDLERS
